...
/**
 * Checks the answer agaist the first element in the returned calculatedCorrectAnswer array
 */
function checkAnswer() {
    ...
    if (isCorrect) {
        ...
        alert(`Awwww... You answered ${userAnswer}. The correct answers was ${calculatedAnswer[0]}!`)
